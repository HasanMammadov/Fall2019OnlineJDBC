...
public class BasicTest {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        String URL = "jdbc:oracle:thin:@35.173.182.240:1521:xe";
        String username = "hr";
        String password = "hr";
...
//        String password = "hr";
         ...
         */
        //this loop will loop though columns for table lables
        for (int columnIndex = 1; columnIndex <= resultSetMetaData.getColumnCount(); columnIndex++) {
            System.out.printf("%-22s", resultSetMetaData.getColumnName(columnIndex));
        }
        System.out.println("");
        //iterate rows
        while (resultSet.next()) {
            //iterate columns
            for (int columnIndex = 1; columnIndex <= resultSetMetaData.getColumnCount(); columnIndex++) {
                System.out.printf("%-22s", resultSet.getString(columnIndex));
            }
            System.out.println("");
        }
